...
(load-library "aspell")
;;chord (keyboard shorcuts without C-/M- modifiers)
;;(load-library "chord")
...
(define-key projectile-mode-map (kbd "s-r") 'projectile-recentf)
...
(setq wg-mode-line-decor-left-brace "["
      wg-mode-line-decor-right-brace "]"  ; Zhow to surround it
